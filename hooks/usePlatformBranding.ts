...
const publicApi = axios.create({ baseURL: env.apiUrl })
...
const DEFAULTS: ResolvedBranding = {
  ...
  heroTitle: "Sua clínica mais inteligente em minutos",
  heroSubtitle: "Agenda, prontuário, financeiro e WhatsApp em uma plataforma potencializada por inteligência artificial.",
