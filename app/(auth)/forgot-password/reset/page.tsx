      ...
      <div className="flex min-h-screen items-center justify-center bg-background p-6">
        <div className="text-center space-y-6 max-w-md">
          ...
          <div className="space-y-2">
            <h2 className="text-3xl font-bold text-foreground">Senha redefinida!</h2>
            <p className="text-muted-foreground">Sua nova senha foi salva. Agora você pode fazer login.</p>
          </div>
